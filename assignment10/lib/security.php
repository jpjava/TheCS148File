...
function securityCheck($path_parts, $yourURL, $form = false) {
    ...
    $whiteListPages[] = "q1.php";
    $whiteListPages[] = "q2.php";
    $whiteListPages[] = "q3.php";
    $whiteListPages[] = "q4.php";
    $whiteListPages[] = "q5.php";
    $whiteListPages[] = "q6.php";
    $whiteListPages[] = "q7.php";
    $whiteListPages[] = "q8.php";
    $whiteListPages[] = "q9.php";
    ...
    $whiteListFolders[] = "/cs148devlop/advising";
